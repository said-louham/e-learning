                ...
                <div className='Section-info'>
                    <div className='section-left'>
                        <div>
                            ...
                            <input type='text' name='fullName' className='input' disabled={DisabledBoolean} value={User?.fullName} onChange={handelChange} />
                        </div>

                        <div>
                            <label> Email </label>
                            <input type='email' name='email' className='input' disabled={DisabledBoolean} value={User?.email} onChange={handelChange} />
                        </div>
                    ...
                    <div className='section-right'>
                        <div>
                            ...
                            <input className='input' name='phoneNumber' type='tele' disabled={DisabledBoolean} value={User?.phoneNumber} onChange={handelChange} />
                        </div>

                        <div>
                            <label> Adresse </label>
                            <input className='input' name='Adresse' type='text' disabled={DisabledBoolean} value={User?.Adresse} onChange={handelChange} />
                        </div>
