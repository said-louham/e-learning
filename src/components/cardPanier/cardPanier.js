...
function CardPanier({ data }) {
  ...
  return (
    <div className="container my-3" style={{ width:"48%",background:''}}>
      ...
      <div className="card-info">
        <div className="action-icons ">
          <MdDeleteSweep className=" mt-4" style={{marginTop:"10px" }} onClick={() =>removFromPanier(data?.id)} />
        </div>
